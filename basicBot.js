...
(function () {
    ...
    var loadChat = function (cb) {
        ...
        $.get("https://raw.githubusercontent.com/Keretasho/basicBot/master/lang/en.json", function (json) {
    ...
    var basicBot = {
        ...
        settings: {
            ...
            "Ich tendiere zu ja.",
            "Ja.",
            "Keine lust dir das zu beantworten, frag Google.",
            "Ohne Zweifel.",
            "Meine Quellen sagen nein.",
            "So wie ich das sehe, ja.",
            "Frag mich wenn ich gerade nicht an mir rumspiele",
            "Konzentriere dich und frage noch einmal.",
            "Sieht nicht gut aus.",
            "Es ist warscheinlich so.",
            "Ich sags dir lieber nicht.",
            "Sehr warscheinlich.",
            "Ja - definitiv.",
            "Es ist möglich.",
            "Kann's gerade nicht sagen.",
            "Ich schau mal in die Kugel..gerade weiß sie es nicht.",
            "Frag mich später, Muggel.",
            "Meine Antwort ist nein, außer Daniel bittet darum.",
            "Sieht gut aus.",
            "Wetten würde ich nicht drauf.",
            "Ja, in nächster Zeit.",
            "Ich frag mal Mutti, sie meint nur wenn du abwäscht.",
            "Sicher nicht.",
            "Du musst warten.",
            ...
            "Warscheinlich.",
            "Verarscht du mich?",
            "Darauf vertrauen würde ich nicht.",
            "Vergiss es."
            ],
            afkpositionCheck: 15,
            ...
            motdEnabled: true,
            motdInterval: 5,
            motd: "Musik ist Leben.(Pip ist ein Noob)",
            filterChat: true,
        ...
        commands: {
            ...
            cookieCommand: {
                ...
                cookies: ['hat dir einen Schokoladenkeks gegeben!',
                    'hat dir einen Keks mit komischen weißen Pulver gegeben!',
                    'hat dir einen alten Keks gegeben..sieht nicht gut aus, schmeckt auch nicht.',
                    'gibt dir einen Keks der wirklich gut riecht..er verneint aber dass Gras drin ist',
                    'gibt dir einen Keks, er sieht aus als wäre er schon auf den Boden gefallen',
                    'gibt dir einen großen Keks, wenn man gegen ihn klopft dupliziert er sich..merkwürdig',
                    'gibt dir einen Keks mit einer Aufschrift: "Iss mich nicht"',
                    'gibt dir einen Keks mit einer Aufschrift: "Keks der Versautheit"',
                    'gibt dir einen Keks mit einer Aufschrift: "Keks der Jungfräulichkeit"',
                    'gibt dir einen Keks mit einer Aufschrift: "Keks mit gewissen Vorzügen"',
                    'gibt dir einen Keks mit einer Aufschrift: "Keks Nummer 3,141"',
                    'gibt dir einen Keks mit einer Aufschrift: "Keks Nummer 69"',
                    'gibt dir einen Keks mit einer Aufschrift "Ich liebe dich..nein Spaß ich brauch 5 Euro.',
                    'gibt dir einen Keks mit einer Aufschrift: "nicht zu viele, du weißt schon"',
                    'gibt dir einen Keks mit einer Aufschrift: "du bist nicht ganz so scheiße"',
                    'gibt dir einen goldenen Keks..hey wie soll man den denn essen!?.',
                    'gibt dir einen Oreo Keks, mjam meine Lieblingskekse!',
                    'gibt dir einen Keks aus Liebe :heart:',
                    'gibt dir einen Keks welcher leicht verbrannt ist(die Kinder in Afrika würden ihn essen!!11).',
                    'backt dir einen frischen Keks, er duftet herrlich.'
                ],
                getCookie: function () {
